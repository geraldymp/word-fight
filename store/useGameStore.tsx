...
export const useGameStore = create<GameState>(set => ({
    ...
    increaseStage: () => set(state => ({ stage: state.stage + 1, selectedEnemy: state.selectedEnemies[state.stage] })),
    ...
    setSelectedEnemies: enemies => {
        set(state => ({ selectedEnemies: enemies, selectedEnemy: enemies[state.stage - 1], enemyHP: enemies[state.stage - 1].baseHp }))
    }
}));
