...
export default function ChooseAreaScreen() {
    ...
    return (
        <View style={styles.container}>
            <Text style={{ color: 'white', alignSelf: 'center', fontSize: 20, marginVertical: 16 }}>Choose your path</Text>
            {choices.map(option => (
                <TouchableOpacity key={option.id} style={styles.card} onPress={() => onPress(option.id)}>
