    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.paragraph}>
          Welcome to <Text style={styles.bold}>Word Fight</Text> — a turn-based
          word battle game!
        </Text>

        <Text style={styles.heading}>🧠 Objective</Text>
        <Text style={styles.paragraph}>
          Create words from 12 random letters to deal damage to the enemy. The
          longer the word, the more damage you deal.
        </Text>

        <Text style={styles.heading}>⚔️ Battle Mechanics</Text>
        <Text style={styles.paragraph}>
          • Select letters to form a word from the given set{'\n'}• Submit the
          word to attack the enemy{'\n'}• Enemy will counterattack after your
        ...
        <Text style={styles.paragraph}>
          You can reshuffle the letters up to{' '}
          <Text style={styles.bold}>2 times per battle</Text> in case
          you&apos;re stuck.
        </Text>

        <Text style={styles.heading}>🏆 Level Progression</Text>
        <Text style={styles.paragraph}>
          After defeating an enemy, you&apos;ll face a stronger one! Each level
          increases enemy health and damage range.
        </Text>

        <Text style={styles.heading}>💡 Tips</Text>
        <Text style={styles.paragraph}>
          • Use high-value letters (like Z, Q, X) for stronger damage{'\n'}• Use
          longer words to deal more damage{'\n'}• Avoid short or weak words if
          possible
        </Text>
